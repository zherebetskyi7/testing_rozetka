...
describe "Main page of rozetka web-site" do
	context "tests all elements on header" do
		it "verification of link 'Вопросы и ответы'" do
		...
		it "verification of link 'Кредит'" do
			@page = SamplePages::Navigation.new
			visit 'http://www.rozetka.com.ua/'
			sleep 5
		...
		it "verification of link 'Доставка и оплата'" do
			@page = SamplePages::Navigation.new
			visit 'http://www.rozetka.com.ua/'
			sleep 5
		...
		it "verification of link 'Гарантия'" do
			@page = SamplePages::Navigation.new
			visit 'http://www.rozetka.com.ua/'
			sleep 5
		...
		it "verification of link 'Контакти'" do
			@page = SamplePages::Navigation.new
			visit 'http://www.rozetka.com.ua/'
			sleep 5
	...
	context "Main menu on main page of rozetka.com.ua" do
		...
		it "verification of sub-menu 'Ноутбуки' => 'Ноутбуки'" do
			@page = SamplePages::Navigation.new
			visit 'http://www.rozetka.com.ua/'
			sleep 5
		...
		it "verification of sub-menu 'SSD накопичувачі'" do
			@page = SamplePages::Navigation.new
			visit 'http://www.rozetka.com.ua/'
			sleep 5
